...
def start_second_dream():
    try: 
        ...
        while True:
            ...
            # 올어라운드 매수 시작
            # -----------------------------------------------------------------
            if len(my_items) < 10  and available_amt > all_around_amt:
                            ...
                            if round(item_income, 2) > add_sell: 
                                ...
                                if my_item['market'].split('-')[1] not in sell_except_item : 
                                    ...
                                    if item_buy < add_buy+10000:
                                        ...
                                        sell_coin = round(Decimal(get_balance(my_item['market']))/item_buy*add_buy,2)
            ...
            logging.info("6. 매수 단위  : " + str("{0:,}".format(buy_amt)))
            # logging.info("7. 보유 종목  : " + str(my_items_comma))
            logging.info("*********************************************************")                         
